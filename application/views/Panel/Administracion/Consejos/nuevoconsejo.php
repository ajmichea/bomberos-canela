		...
		<div class="span12">
			<div class="widget">
				...
				<div class="widget-content">
					...
					<?php echo form_open_multipart('Panel/Cargarconsejo', $atributos_form) ?>
						<div class="row">
							<div class="span5">
								<div class="control-group">
									...
									<div class="controls">
										<label class="radio inline">
											<input type="radio" name="tp_consejo" value="Hogar"> Hogar
										</label>
										<label class="radio inline">
											<input type="radio" name="tp_consejo" value="Trabajo"> Trabajo
										</label>
										<label class="radio inline">
											<input type="radio" name="tp_consejo" value="Comunidad"> Comunidad
										</label>
									</div>
								</div>		
								<div class="control-group">											
							...
							<div class="span6">
								...
								<textarea name="parrafo_introduccion" placeholder="Máximo 100 caracteres..." maxlength="100" rows="2" class="parrafo"></textarea>
								<br>
								<br>
								<div class="alert alert-success">
									<strong><center>Ingresar contenido del consejo</center></strong>
								</div>
